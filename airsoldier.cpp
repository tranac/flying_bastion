...
An Item is created with these coordinates. x is always 645, the right boundary of the game. Initial v is always 10, at the top of the screen. vx is -1 and vy is initially 0. It will be changed in move().
*/
